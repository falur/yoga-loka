 ...
 * (eager-load делает репозиторий самого Media методом с ->load('imageConversions') и соседними).
 * Соседний модуль так не может: ORM-связи на сущность Media у него нет, данные медиа он получает
 * через Media/Public пакетным вызовом.
