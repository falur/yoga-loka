 ...
 * (rules.md:65). action — вложенный nullable DTO либо null, actor — снимок автора
 * {id, name, avatarUrl} либо null (открытое приложение покажет аватар без запроса к профилю).
 */
final readonly class RealtimeNotificationPayload implements \JsonSerializable
{
    ...
    /**
     * @return array<string, string|NotificationActionPayload|NotificationActorPayload|null>
     */
    #[\Override]
