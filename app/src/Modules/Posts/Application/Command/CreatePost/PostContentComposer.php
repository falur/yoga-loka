 ...
 *
 * Лежит рядом с CreatePost, но используется также PublishPost/RepostPost/LikePost (по факту
 * инъекции в их конструкторы) — общая сборка содержимого и уведомлений записи не привязана к одной
 * команде жизненного цикла записи.
 */
