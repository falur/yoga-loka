...
final readonly class CommentDeletionReason implements \Stringable, \JsonSerializable
{
    ...
    public static function of(string $value): self
    {
        ...
        if ($reason === '' || \mb_strlen($reason) > self::MAX_LENGTH) {
            throw new InvalidDomainValueException('Причина удаления комментария имеет неверную длину.');
        }
