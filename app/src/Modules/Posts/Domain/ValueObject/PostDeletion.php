...
/**
 * Мягкое удаление записи: null-object VO поверх nullable datetime (образец MediaExpiration).
 * notDeleted() — запись активна, deletedAt() — момент мягкого удаления.
 */
final readonly class PostDeletion implements \Stringable, \JsonSerializable
{
    ...
    public static function deletedAt(\DateTimeImmutable $deletedAt): self
    {
