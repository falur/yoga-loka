...
namespace App\Modules\Posts\Infrastructure\Bootloader;
...
/**
 * Бутлоадер модуля Posts. Регистрирует виды уведомлений модуля в реестре Notifications: реестр —
 * синглтон, накапливающий регистрации модулей-источников, поэтому регистрация делается в boot()
 * (после поднятия NotificationsBootloader в Kernel). Все виды модуля — один enum PostNotificationType,
