...
/**
 * Лайк комментария: authUserId из request-атрибута (auth-middleware) и <id> комментария из пути (uuid, иначе 422).
 */
final class LikeCommentFilter extends AttributesFilter
{
