...
/**
 * Снятие лайка записи: authUserId из request-атрибута (auth-middleware) и <id> записи из пути (uuid, иначе 422).
 */
final class UnlikePostFilter extends AttributesFilter
{
