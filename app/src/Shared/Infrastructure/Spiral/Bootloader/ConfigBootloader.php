...
{
    private const string CONFIGURATION_DIRECTORY = 'app/src/Shared/Infrastructure/Spiral/Configuration';
    private const string CONFIGURATION_NAMESPACE_PREFIX = 'App\\Shared\\Infrastructure\\Spiral\\Configuration\\';
