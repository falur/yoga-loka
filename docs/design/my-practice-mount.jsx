// my-practice-mount.jsx — телефон «Цветной» + переключатель светлой/тёмной темы
const { useState: uMM } = React;

function MyPracticeMount() {
  const [dark, setDark] = uMM(false);
  ...
  return (
    <div style={{
      ...
      <IOSDevice width={390} height={844} dark={dark}>
        <MyPracticeScreen dark={dark} />
      </IOSDevice>
    </div>
  );
}

ReactDOM.createRoot(document.getElementById('root')).render(<MyPracticeMount />);
