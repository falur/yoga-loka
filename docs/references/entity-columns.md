...
В миграции имя таблицы и колонки остаются строковым литералом: миграция фиксирует схему на момент применения и не следует за переименованием — см. карточку [Миграция](migration.md).
