...
final class DisallowLooseComparisonRule implements Rule
{
    ...
    private const string LOOSE_EQUAL_IDENTIFIER = 'gianTiaga.phpstanStrictRules.looseEqualForbidden';
    private const string LOOSE_NOT_EQUAL_MESSAGE = 'Loose not-equal comparison is forbidden. Use !== instead.';
    private const string LOOSE_NOT_EQUAL_IDENTIFIER = 'gianTiaga.phpstanStrictRules.looseNotEqualForbidden';
