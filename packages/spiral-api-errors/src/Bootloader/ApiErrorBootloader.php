...
namespace GianTiaga\SpiralApiErrors\Bootloader;
...
final class ApiErrorBootloader extends Bootloader
{
    ...
    public function apiValidationErrorsRenderer(LoggerInterface $logger, TranslatorInterface $translator): ApiValidationErrorsRenderer
    {
        return new ApiValidationErrorsRenderer(logger: $logger, translator: $translator);
    }
    public function apiExceptionInterceptor(LoggerInterface $logger, TranslatorInterface $translator): ApiExceptionInterceptor
    {
        return new ApiExceptionInterceptor(logger: $logger, translator: $translator);
    }
    public function routeNotFoundMiddleware(LoggerInterface $logger, TranslatorInterface $translator): RouteNotFoundMiddleware
    {
        return new RouteNotFoundMiddleware(logger: $logger, translator: $translator);
    }
}
