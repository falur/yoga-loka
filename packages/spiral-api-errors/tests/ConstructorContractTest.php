...
namespace GianTiaga\SpiralApiErrors\Tests;
...
final class ConstructorContractTest extends TestCase
{
    ...
    {
        $this->assertRequiredTranslatorParameter(className: RouteNotFoundMiddleware::class, parameterIndex: 1);
        $this->assertRequiredTranslatorParameter(className: ApiValidationErrorsRenderer::class, parameterIndex: 1);
        $this->assertRequiredTranslatorParameter(className: ApiExceptionInterceptor::class, parameterIndex: 1);
    }
    /**
