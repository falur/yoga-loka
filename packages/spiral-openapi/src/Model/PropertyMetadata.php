...
final readonly class PropertyMetadata
{
    ...
    public function __construct(public string $name, public string $type, public bool $nullable, public bool $hasDefault, public string $source, public string|null $listItemType = null) {}
